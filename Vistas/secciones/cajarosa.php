...
<div class="container-fluid">
   	  ...
   	  <div class="col-lg-3">
   		  <div class="form-group">
                ...
                <datalist id="browsers"></datalist>
                    <!--<input class="form-control" type="text" name="key1" id="key1" placeholder="Buscar..." autocomplete="off">
 ...
 <div class="row">
      ...
      <div style="display:none" id="footer">        
        <p>Total venta :<p id = "totalventapdf"></p></p>
      </div>
      </div>
